...
## The Domains/Concepts covered in this project: `UnitTests` `Back-end` `Integration tests`

This project introduced me to Unit Tests and Integration Tests, essential practices for ensuring code reliability and functionality. I learned how to write comprehensive test cases using `Python's unittest framework`, mock dependencies, and validate interactions between different components to build robust and maintainable backend applications.
